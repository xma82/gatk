...
public class FuncotatorArgumentCollection implements Serializable {
    ...
    @Argument(
            ...
            optional = true,
            doc = "Variants within this many bases of the 5' end of a gene will be considered to be upstream/downstream of that gene"
    )
    ...
    @Argument(
            ...
            optional = true,
            doc = "Variants within this many bases of the 3' end of a gene will be considered to be upstream/downstream of that gene"
    )
